...
public class JSFUtil {
    ...
    public static void addInfoMessageSimulador(String message) {
        FacesMessage facesMessage = new FacesMessage(FacesMessage.SEVERITY_INFO, message, message);
        FacesContext.getCurrentInstance().addMessage(null, facesMessage);
    }
    
    public static void addErrorMessageSimulador(String message) {
    ...
    public static String mensagemComHora(String msg) {
        return new SimpleDateFormat("HH:mm:ss ").format(new Date()).toString() + msg;
    }
    ...
    public static void tratarExcecao(Exception e) {
        if (e instanceof AppException) {
             ...
             */
            if (((AppException) e).getTipoException().equals(TipoException.INFO)) {
                addInfoMessage(e.getMessage());
            }
            if (((AppException) e).getTipoException().equals(TipoException.WARN)) {
                addInfoWarning(e.getMessage());
            }
            if (((AppException) e).getTipoException().equals(TipoException.ERROR)) {
             ...
             * Lanзa Erro genйrico
             */
            addErrorMessage("Ocorreu uma falha inesperada no sistema. Erro: " + e.getMessage());
        }
    }
